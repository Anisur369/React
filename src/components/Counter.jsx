...
function Counter(){
    ...
    return (
        <div>
            ...
            <button type="button" onClick={()=>dispatch({type:'increment2',value:2})}>Increment2</button>
            <button type="button" onClick={()=>dispatch({type:'decrement2',value:2})}>Decrement2</button>
        </div>
    )
}
